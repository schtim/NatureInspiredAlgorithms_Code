            ...
            for mutation_prob in mutation_probability_vals:
                for number_gens in number_generation_vals:
                    for fitness_function in fitness_function_vals:
                        ...
                        res_string = f'Params:\t[{pop_size:5.0f},{crossover_prob:1.2f},{mutation_prob:1.2f},{number_gens:5.0f},{fitness_function:15s}] \t Res:\t[{average_all_time_best:8.4f},{average_average_vals:8.4f},{average_runtime:10.2f}]'
